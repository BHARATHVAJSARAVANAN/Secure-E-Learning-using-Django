...
class LearningResource(models.Model):
    ...
    course_organization = models.CharField(max_length=1000, blank=True, null=True)
    course_certificate_type = models.CharField(max_length=1000, blank=True, null=True)
    course_duration = models.CharField(max_length=1000, blank=True, null=True)
    course_rating = models.FloatField(max_length=1000, blank=True, null=True)
    course_reviews_num = models.IntegerField(blank=True, null=True)
    course_difficulty = models.CharField(max_length=1000, blank=True, null=True)
    course_url = models.URLField(max_length=1000, blank=True, null=True)
    course_students_enrolled = models.CharField(max_length=1000, blank=True, null=True)
    course_skills = models.TextField(max_length=1000, blank=True, null=True)
    course_summary = models.CharField(max_length=1000, blank=True, null=True)
